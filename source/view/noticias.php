...
<div class="row g-0">
    ...
    <section class="col-12 col-sm-4 col-lg-3 ps-3 mt-3 mt-sm-0">
        <h2 class="h3">Sobre o Projeto</h2>
        <p>Este portal de notícias foi desenvolvido conforme especificado na etapa de <u>Produção Temática</u> do <u>PSI 12017</u> para a vaga de Assistente júnior demandado pela CEHAN.</p>
        <p class="mb-0">Além da escrita, leitura, edição e exclusão de uma notícia (CRUD), ele contém as seguintes funcionalidades:</p>
        <ul>
